  ...
  return (
    <div className="div_container">
      ...
      <p>
        ...
        automaticamente a diferentes tamanhos de tela. É comumente utilizado em
        interfaces mobile-first, onde o design começa com dispositivos móveis e
        se expande para dispositivos maiores.
      </p>
      <p>
        ...
        diferentes folhas de estilo, scripts ou até mesmo diferentes versões do
        site que são mostradas conforme o tipo de dispositivo detectado.
      </p>
      <p>
